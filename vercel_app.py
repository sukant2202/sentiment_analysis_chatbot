...
def home():
    ...
    <html>
    <head>
        <title>SentimentBot Pro - Root Entry Point 🎉</title>
        <style>
    ...
    <body>
        <div class="container">
            ...
            <p class="status">✅ Root Entry Point Working!</p>
            ...
            <p><strong>Status:</strong> Root entry point is working successfully!</p>
        </div>
    </body>
    </html>
    """)
...
def health():
    return jsonify({
        "status": "healthy",
        "message": "SentimentBot Pro root entry point is working",
